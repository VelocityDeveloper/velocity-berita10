...
function velocity_popular_posts(){
	...
	echo '<div class="velocity-popular-posts">';
		...
		<div class="velocity-popular-list mb-3">
			...
			<small class="text-secondary fst-italic"><?php velocity_post_date(get_the_ID());?>  |  <?php echo get_post_meta(get_the_ID(), 'hit', true);?> dilihat</small>
		</div>
	<?php endwhile;
	echo '</div>';
	endif;
