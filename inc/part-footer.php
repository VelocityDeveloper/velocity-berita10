<footer class="site-footer" id="colophon">
    <div class="container">
    <div class="row align-items-center text-center m-0 bg-dark text-white py-2">
        <div class="col-md-4 order-md-2 text-center text-md-end pt-2 pt-md-0">
            <?php
            $sosmed = [
        ...
        <div class="col-md-8 order-md-1 text-md-start my-2 my-md-0">
