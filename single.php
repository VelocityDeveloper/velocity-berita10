        ...
        <div class="col-md-8 pt-2">
            <?php while ( have_posts() ) : the_post(); ?>
                <header class="mb-3">
                    ...
                    <?php the_title( '<h1 class="h6 secondary-font fw-bold color-theme mt-1">', '</h1>' ); ?>
                    <div class="text-secondary velocity-post-info">
                        ...
                        <div class="px-2 d-inline-block"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-clock align-middle" viewBox="0 0 16 16">
